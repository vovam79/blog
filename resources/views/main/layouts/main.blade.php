...
<header class="edica-header">
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="{asset('index.html')}"><img src="{{asset('assets/images/logo.svg')}}" alt="Edica"></a>
            ...
            <div class="collapse navbar-collapse" id="edicaMainNav">
                <ul class="navbar-nav mx-auto mt-2 mt-lg-0">
                    ...
                    <!--
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="{asset('')}" id="pagesDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Pages</a>
...
-->
<footer class="edica-footer " data-aos="fade-up" style="margin-top: 100px">
    <div class="container">
